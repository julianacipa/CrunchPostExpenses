...
/**
 Initialize with key and tokens, i.e. we have already authenticated the user
 */
- (instancetype)initWithConsumerKeyAndToken:(NSString *)consumerKey consumerSecret:(NSString *)consumerSecret token:(NSString*)token tokenSecret:(NSString*)tokenSecret;
